...
public class TestIdMaestroAlumno {
  ...
  @Test
    ...
    public void testIntendente1() {
        assertEquals("Intendente", idMAEjemplo.valorMA(3,"901"));
}
  @Test
    public void testIntendente2() {
        assertEquals("Intendente", idMAEjemplo.valorMA(3,"994"));
}
//Test incorrectos
 @Test
  ...
  @Test
    ...
    public void testIntendente3() {
        assertEquals("Intendente", idMAEjemplo.valorMA(3,"0"));
}
  @Test
    public void testIntendente4() {
        assertEquals("Intendente", idMAEjemplo.valorMA(3,"10000"));
}    
